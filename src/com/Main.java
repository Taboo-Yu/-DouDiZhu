...
public class Main extends JFrame implements ActionListener {
	...
	JMenuItem start, exit, about,chongzhi;// 定义菜单按钮
...
public Main(){
	...
	public void Init() {
		...
		container.setBackground(new Color(46, 139, 87)); // 背景为绿色
	...
	public void SetMenu() {
		...
		JMenu hh = new JMenu("充Q币吗？");

		start = new JMenuItem("新游戏");
		exit = new JMenuItem("退出");
		about = new JMenuItem("关于");
        chongzhi = new JMenuItem("充值");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == about) {
			JOptionPane.showMessageDialog(this, "坤坤斗地主");
		}
		...
		if (e.getSource() == chongzhi) {
			JOptionPane.showMessageDialog(this, "想想你的家庭");
		}
...
class NewTimer implements Runnable{
	...
	public void run() {
		...
		main.t=new Time(main,15);//从10开始倒计时
		main.t.start();
	}
